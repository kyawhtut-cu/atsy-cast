...
internal class PlayerViewModel @Inject constructor(
    ...
    var videoID: String = savedStateHandle.get(Constants.EXTRA_VIDEO_ID) ?: ""
    ...
    val episodeList: List<EpisodeResponse.Data> by lazy {
    ...
    fun updatePlayerPositionCache(lastPosition: Long, duration: Long) {
        ...
        repository.insertLastPosition {
            ...
            videoSubtitle = this@PlayerViewModel.videoSource!!.subTitle
        }
    }
}
