...
function convertAllEscapes(str) {
  ...
  Logger.log(`convertUnicode2Char ` + str)
  str = convert0x2Char(str)
  Logger.log(`convert0x2Char ` + str)
  str = convertuBracket2Char(str)
  Logger.log(`convertuBracket2Char ` + str)
  str = convertuBrSequence2Char(str)
  Logger.log(`convertuBrSequence2Char ` + str)
  str = convertxBracket2Char(str)
  Logger.log(`convertxBracket2Char ` + str)
  str = convertx002Char(str)
  Logger.log(`convertx002Char ` + str)
  str = convertHexNCR2Char(str)
  Logger.log(`convertHexNCR2Char ` + str)
  str = convertDecNCR2Char(str)
  Logger.log(`convertDecNCR2Char ` + str)
  str = convertU0000002Char(str)
  Logger.log(`convertU0000002Char ` + str)
  str = convertU00002Char(str)
  Logger.log(`convertU00002Char ` + str)
  str = convertCSS2Char(str, false)
  Logger.log(`convertCSS2Char ` + str)
  str = convertpEnc2Char(str)
  Logger.log(`convertpEnc2Char ` + str)
  str = convertEntities2Char(str)
  Logger.log(`convertEntities2Char ` + str)
  str = convertGreenNumbers2Char(str, ``)
  Logger.log(`convertGreenNumbers2Char ` + str)
